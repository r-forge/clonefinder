...
We want to cluster the break-point sequences. In order to make use of existing algorithms,
...
Now we want to cluster the long-read break point sequences. The core algorithm is the classic
...
```{r compute.distances}
seqclust <- SequenceCluster(pseudo, NC = 20)
